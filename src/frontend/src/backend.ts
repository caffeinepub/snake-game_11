...
import type { UserProfile as _UserProfile, UserRole as _UserRole, WakeUpSettings as _WakeUpSettings } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async getAllUserRecords(): Promise<Array<[Principal, WakeUpSettings, bigint]>> {
        if (this.processError) {
            try {
    ...
    async getPhotoSubmissions(): Promise<Array<PhotoSubmission>> {
        if (this.processError) {
            try {
                const result = await this.actor.getPhotoSubmissions();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getUserPhotoSubmissions(arg0: Principal): Promise<Array<PhotoSubmission>> {
        if (this.processError) {
            try {
                const result = await this.actor.getUserPhotoSubmissions(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getWakeUpTime(): Promise<WakeUpSettings | null> {
        if (this.processError) {
            try {
                const result = await this.actor.getWakeUpTime();
    ...
    async setWakeUpTime(arg0: WakeUpSettings): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.setWakeUpTime(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async submitPhoto(arg0: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.submitPhoto(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function from_candid_opt_n9(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_WakeUpSettings]): WakeUpSettings | null {
    return value.length === 0 ? null : value[0];
}
